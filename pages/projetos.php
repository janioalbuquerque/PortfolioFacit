...
<div class="div-background-projetos" style="background-image: url('../img/painel/perfil/bg-1-projetos.jpg'); height: 100%; background-size: cover;" >
    <div class="pt-5">
        ...
        a sua visita. 
                                    ...
                                    <!--FINALIZANDO CHAMADA DE BOAS VINDAS-->

                                   <!--INICIANDO CARDS COM DESTAQUES-->

<div >
  <div style=" background-image: url('../img/bg-2-projetos.jpg'); background-size: cover;" class="card-group">
        ...
        <a style="text-decoration: none; color:black;" href="../index.php">
            ...
            <div style="background-color: rgba(230, 230, 230, 1);" class="card-body">
                ...
                <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                               ...
                               <!-----------INICIANDO CAROUSEL----------->
<div style="background-image: url('../img/bg-3-projetos.jpg'); background-size: cover;" >
...
<div class="container pt-5" >
        ...
        <div  id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" style="box-shadow: 5px 5px 5px;">
                <div class="carousel-item active">
                    <img src="../img/destaque-1.jpg" class="d-block  w-100 h-80" alt="...">
                ...
                <div class="carousel-item">
                    <img src="../img/destaque-2.jpg" class="d-block  w-100 h-80" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="../img/destaque-3.jpg" class="d-block w-100 h-80" alt="...">
                    <div class="carousel-caption d-none d-md-block">
