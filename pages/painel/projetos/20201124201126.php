...
$qry = "SELECT * FROM trabalhosport WHERE video = '20201124201126.jpg'";
...
<div style="text-align: justify;" class="w-100 p-2">
    <?php echo '<img style="width: 500px; height: 350px !important;" src="data:image/jpeg;base64,' . base64_encode( $fila['img_right'] ) . '" class="img-fluid float-right p-4 mt-5" alt="Responsive image">' ?>
        ...
        <div style="align-items: center; text-align: center;" class="container mb-5 mt-5">
        <iframe class="iframe" width="80%" height="400px" src="https://datastudio.google.com/embed/reporting/195ec41f-2a19-4db7-8aea-767094e5f255/page/GBbUB" frameborder="0" style="border:0" allowfullscreen></iframe>
    </div>
