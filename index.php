    ...
    <div class="row col-12 ">
                ...
                <div  class="carousel-inner">
                  ...
                  <div class="carousel-item carousel-fade" data-interval="2000">
                    <img src="img/banner-3.png" class="d-block w-100" alt="...">
                                    ...
                                    <!--FINALIZANDO CAROUSEL MOSTRANDO BANNERS DOS CURSOS-->
        ...
        <div class="col-12 mt-5 ">
          ...
          <button   type="button " class="btn float-right mt-5 mr-5 mx-auto bg-roxo "> <a style="text-decoration: none; color: white;" href="sobre.php"> Conheça o Curso <img src="https://img.icons8.com/dotty/24/000000/filled-sent.png "/></a></button>
                                    ...
                                    <!--FINALIZANDO CHAMADA PARA CLICAR NO BOTÃO CONHEÇA O CURSO-->

<!--=================================================FINALIZANDO SESSÃO 1==============================================-->
<!--==================================================INICIANDO SESSÃO 2==============================================-->
    ...
    <div class="mt-5" style="width: 100%; background-color: rgba(180, 198, 240,1);">
        <div class="row col-12 video-index">
            ...
            <div class="col-sm-12 col-md-12 col-lg-5 mt-5 mb-5">
            
              
                <video class="mt-4 video-01" width="100%" autoplay="" muted="" loop="">
                    <source src="img/video-03.mp4" type="video/mp4">
                      ...
                      <!--FINALIZANDO VIDEO PEQUENO // FACIT APRESENTA-->
        ...
        <div  class="col-sm-12 col-md-12 col-lg-6 mt-5 ml-3 mb-5 texto-video-index">
            ...
            <h5 style="font-weight: bold; text-align:justify;" class="mt-5">
                ...
                vez mais promissor. Uma pequisa internacional apontou que as profissões do 
                futuro vão estar ligadas ao setor da tecnologia e informática. Entre essas profissões, 
                destaca-se a de programador que é uma das atividades trabalhadas 
                ao longo do curso de Análise e Desenvolvimento de Sistemas.
            </h5>

            <h5 style="font-weight: bold;  text-align:justify;" class="mt-3">
                
                    O aluno vai contar com uma estutura de ponta, materiais didáticos, um laboratório que possibilita
                    o aprendizado constante e leva o futuro profissional a ter um contato com a prática 
                    logo no início de sua vida acadêmica. 
                
            </h5>

        </div>
                        <!--FINALIZANDO TEXTO DO LADO DO VIDEO--------->

    </div>
    </div>
<!--=================================================FINALIZANDO SESSÃO 1==============================================-->
<!--=================================================INICIANDO O VIDEO DE BACKGROUND==============================================-->
                                    
    <div style="width: 100%; height: 100%;">
        <video width="100%" autoplay="" muted="" loop="" class="bg_video">
            <source src="img/video-01.mp4" type="video/mp4">
        </video>	       

                              <!--============FINALIZANDO O VIDEO DE BACKGROUND===========================-->
      ...
      <div class="card m-5 shadow p-3 mb-5 bg-white rounded card-index" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-primary">Ver Trabalho</a>
                                    ...
                                    <!--FINALIZANDO CARDS COM DESTAQUES-->
  ...
  <div style="height: 100%; transition: 1s;" class="carousel-inner">
    ...
    <div class="carousel-item">
      <img style="width: 80%; height: 90%; margin: 0 auto; transition: 1s;"  class="d-block w-80 carousel-rodape-index" src="img/b2.jpg" alt="First slide">
                                    ...
                                    <!--FINALINANDO CAROUSEL GRANDE MEIO DO SITE-->

<!--=================================================FINALIZANDO SESSÃO 2==============================================-->
